% Por motivos de rapidez, esta apresentação é uma variante de uma apresentação
% sobre Software Livre e a ANSOL, que pode ser encontrada em
% https://github.com/marado/ANSOL-MOSS
...
% Define o titulo
\title{Introdução às Tecnologias Livres}

% Define a data
\date{Moon Dance Chill Out Party -- 2016}
...
\begin{slide}
  \includegraphics[scale=0.8]{poster.png}
...
\includegraphics[scale=1.3]{garra-makey.png}
\end{slide}

\begin{slide}
Energia Livre

\includegraphics[scale=2.7]{oemfpsystemdiagram.png}
\end{slide}

\begin{slide}
Construção Aberta

\includegraphics[scale=0.9]{open-building.png}
\end{slide}

\begin{slide}
Ensino Livre

\includegraphics[scale=1.1]{AEL.png}
\end{slide}

\begin{slide}
Cultura Livre\\
\includegraphics[scale=1.0]{open-culture-timeline-1.jpg}

\includegraphics[scale=1.0]{open-culture-timeline-2.jpg}
\end{slide}
...
% gnu/linux, android/cm, firefox, libreoffice, gimp, ardour, blender
\begin{slide}
Exemplos de Software Livre -- GNU/Linux (Sistema Operativo)\\
\includegraphics[scale=0.35]{desktop.png}

Exemplos de Software Livre -- Android, CyanogenMod\\
\includegraphics[scale=0.6]{android-cm.jpg}

Exemplos de Software Livre -- Firefox (Navegador Web) \\
\includegraphics[scale=0.62]{firefox.png}

Exemplos de Software Livre -- LibreOffice (Produtividade) \\
\includegraphics[scale=0.62]{libreoffice.png}

Exemplos de Software Livre -- The GIMP (Edição de imagem) \\
\includegraphics[scale=0.5]{gimp.png}

Exemplos de Software Livre -- Ardour (Estúdio de música) \\
\includegraphics[scale=0.6]{ardour.png}

Exemplos de Software Livre -- Blender (Editor de Animação 3D) \\
\includegraphics[scale=0.34]{blender.jpg}
\end{slide}

\begin{slide}
Como contribuir para o Software Livre
\begin{itemize}
\item{} O Software que usa tem um problema? Reporte-o!
\item{} Sabe programar? Ajude a resolver problemas!
\item{} Envolva-se com a comunidade dos projectos de Software Livre que gosta
\item{} Sente-se aventureiro? Use versões de teste e dê feedback!
\item{} Ajude a criar novas funcionalidades
\item{} Ajude com traduções
\item{} Reveja a documentação
\item{} Participe na manutenção do site, forums, \ldots
\end{itemize}
\end{slide}

% FLYERS ANSOL
\begin{slide}
\includegraphics[scale=0.8]{ANSOL.png}
\end{slide}
...
% SHORT VERSION - comment this and uncomment the long version instead, if you want % TODO - make this an includeble .tex file
\begin{itemize}
  \item{} Organização de eventos
    \begin{itemize}
      \item{} Porto 2002, Cidade Tecnológica -- Sistemas Livres
      \item{} Richard Stallman em Portugal (2003)
      \item{} Em 2008, ANSOL começa a celebração anual do ``Document Freedom Day'' em Portugal
      \item{} Celebração anual do dia ``Eu $<3$ Software Livre''
      \item{} Education Freedom Day
      \item{} Dar a conhecer a Liberdade que vem do Software Livre, no Dia da Liberdade
      \item{} O Software Freedom Day é celebrado anualmente, em Setembro
      \item{} \ldots
    \end{itemize}
  \item{} Política
    \begin{itemize}
      \item{} Transposição da Directiva Europeia para a Legislação Portuguesa (2002--2004)
      ...
      \item{} Lei das Normas Abertas aprovada na Assembleia da República (2011)
  ...
  \item{} Comunidade
    \begin{itemize}
      ...
      \item{} Esclarecimentos sobre várias temáticas (Licenças de Software, Normas Abertas, \ldots)
    \end{itemize}
\end{itemize}

% LONG VERSION - uncomment this instead of the short version... % TODO - make this an included .tex file
% 
% \begin{itemize}
...
A ANSOL em 2016 depende de todos!
\end{slide}
...
\emph{http://fsfe.org} \\
\emph{http://fsf.org} \\
\emph{https://github.com/marado/freetech} 
